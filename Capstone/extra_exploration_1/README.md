...
Turn any prompt into a 512-by-512 image using **Stable Diffusion v1.5** (🤗 **diffusers**) wrapped in a clean **Gradio** UI.  
...
An example output using Hugging Face's free CPU is
